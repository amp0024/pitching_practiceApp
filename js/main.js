...
$(document).on('ready', function() { 
	...
	for (var i = 0; i <= 25 ; i++){
	    	...
	    	if ($this.hasClass('selected')) {
				...
				clickedArray.push(1);
				$('#playerResults').append('<tr><td>'+(pitchArr[count].type)+'</td><td>'+(pitchArr[count].desc)+'</td><td>'+'<span class="label label-warning"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span><bold>  + 1</bold></span>'+'</td></tr>');
...
var pitchArr = [
	...
	{loc: 22, bonus: 23, loc2: 24, type:'Breaking Ball', desc: 'Chase middle down'},
	{loc: 2, bonus: 3, loc2: 4, type:'Fastball', desc: 'Up & out of the zone'},
	/////////////////////////////////////////////////////////////////////
	{loc: 17, bonus: 18, loc2: 19, type:'Breaking Ball', desc: 'Low Strike'},
	{loc: 0, bonus: 17, loc2: 0, type:'Change Up', desc: 'Low & outside for a strike'},
	{loc: 16, bonus: 21, loc2: 22, type:'Breaking Ball', desc: 'Down & away for a ball'},
	{loc: 2, bonus: 3, loc2: 4, type:'Fastball', desc: 'Up & out of the zone'},
	{loc: 0, bonus: 19, loc2: 0, type:'Change Up', desc: 'Low & inside for a strike'},
	/////////////////////////////////////////////////////////////////////
	{loc: 17, bonus: 12, loc2: 7, type:'Fastball', desc: 'Inside corner'},
	{loc: 17, bonus: 18, loc2: 19, type:'Change Up', desc: 'Low strike'},
	{loc: 10, bonus: 15, loc2: 20, type:'Fastball', desc: 'Outside and off the plate'},
	{loc: 22, bonus: 23, loc2: 24, type:'Breaking Ball', desc: 'Chase middle down'},
	{loc: 0, bonus: 17, loc2: 0, type:'Change Up', desc: 'Low and inside'}
]
